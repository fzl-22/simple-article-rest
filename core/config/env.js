...
const MONGODB_TEST_DB_NAME = process.env.MONGODB_TEST_DB_NAME;
...
const TEST_DB_URL = `mongodb+srv://${MONGODB_USERNAME}:${MONGODB_PASSWORD}@${MONGODB_CLUSTER}/${MONGODB_TEST_DB_NAME}?retryWrites=${MONGODB_RETRY_WRITES}&w=${MONGODB_WRITE_CONCERN}&appName=${MONGODB_APP_NAME}`;

const JWT_SECRET_KEY = process.env.JWT_SECRET_KEY;

module.exports = { HOST, PORT, DB_URL, TEST_DB_URL, JWT_SECRET_KEY };
